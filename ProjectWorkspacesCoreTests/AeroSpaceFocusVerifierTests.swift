...
final class AeroSpaceFocusVerifierTests: XCTestCase {
    ...
    func testVerifySucceedsAfterRetries() {
        ...
        XCTAssertEqual(sleeper.calls.count, 2)
        XCTAssertEqual(sleeper.calls[0], 0.05, accuracy: 0.001)
    }
    ...
    func testVerifyHandlesEmptyWindowList() {
        let query = TestFocusedWindowQuery(responses: [
            .success([]),
            .success([]),
            .success([])
    ...
    func testVerifyMatchesWorkspaceExactly() {
        let query = TestFocusedWindowQuery(responses: [
            .success([
                AeroSpaceWindow(
                    windowId: 42,
